...
/**
 * @thanks https://github.com/matyhtf/framework/blob/master/libs/Swoole/Queue/MsgQ.php
 */

/**
 * Class tea_sysvmsg - based system v message queue
 */
class tea_sysvmsg extends BaseQueue
{
    private $queues = [];
    ...
    protected function doPop($priority = null, $block = false)
    {
        ...
        if ($this->isPriority($priority)) {
            ...
            if (!$this->hasQueue($priority)) {
                $this->createQueue($priority); //未初始化先初始化
            }
